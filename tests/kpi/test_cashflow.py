...
class TestCashflow(unittest.TestCase):
    ...
    def test_cfo_quality_high(self):
        self.assertEqual(cfo_quality_score(200, 100), "High Quality")

    def test_cfo_quality_moderate(self):
        self.assertEqual(cfo_quality_score(75, 100), "Moderate")

    def test_cfo_quality_risk(self):
        self.assertEqual(cfo_quality_score(20, 100), "Accrual Risk")
    ...
    def test_reinvestor_pattern(self):
        self.assertEqual(capital_allocation_pattern(100, -100, -50), "Reinvestor")

    def test_shareholder_returns(self):
        self.assertEqual(
            capital_allocation_pattern(100, -100, -50, "High Quality"),
            "Shareholder Returns",
        )
