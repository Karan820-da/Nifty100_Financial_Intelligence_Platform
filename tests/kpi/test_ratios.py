...
class TestProfitabilityRatios(unittest.TestCase):
    ...
    def test_return_on_equity(self):
        self.assertEqual(return_on_equity(100, 500, 500), 10.00)

    def test_negative_equity(self):
        self.assertIsNone(return_on_equity(100, -500, -200))

    def test_return_on_assets(self):
        self.assertEqual(return_on_assets(120, 1200), 10.00)

    # ===== Day 09 Tests =====

    def test_debt_to_equity(self):
        self.assertEqual(debt_to_equity(100, 200, 300), 0.20)

    def test_debt_free_de_ratio(self):
        self.assertEqual(debt_to_equity(0, 200, 300), 0)

    def test_high_leverage_flag(self):
        self.assertTrue(high_leverage_flag(6.5, "Technology"))

    def test_high_leverage_financials(self):
        self.assertFalse(high_leverage_flag(6.5, "Financials"))
    ...
    def test_net_debt(self):
        self.assertEqual(net_debt(1000, 400), 600)

    def test_asset_turnover(self):
        self.assertEqual(asset_turnover_ratio(1000, 500), 2.0)
